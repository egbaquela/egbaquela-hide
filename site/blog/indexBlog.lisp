  ...
  (
    ...
    (cat
      ...
      (div :ng-app "indiceApp" :ng-controller "indiceCtrl as vc"
        ...
        (div :ng-repeat "post in vc.listaPosts | filter:{tituloArticulo: vc.filtroTituloArticulo, resumenArticulo:vc.filtroResumenArticulo, etiquetasArticulo:vc.filtroEtiquetasArticulo} | orderBy: 'fechaCreacion'"
          ;; Preview artículo
          ;;(div :class "ui vertical stripe segment"
      ...
      angular
        ...
        .controller('indiceCtrl', function() {
          ...
          indice.listaPosts = [
            ...
            {'tituloArticulo':'Tutorial de Emacs', 'resumenArticulo':'Link a excelente tutorial de EMACS.', 'linkArticulo':'20151031-tutorialEmacs', 'fechaCreacion': '20151031', 'etiquetasArticulo':''}
          ];
